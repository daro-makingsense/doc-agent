    ...
    async def _analyze_topic(self, state: ResearchState) -> ResearchState:
        ...
        try:
            ...
            analysis_prompt = ChatPromptTemplate.from_messages([
                ("system", """You are a financial research analyst. Analyze the given research topic and provide context.
    ...
    async def _generate_research_questions(self, state: ResearchState) -> ResearchState:
        ...
        try:
            ...
            question_prompt = ChatPromptTemplate.from_messages([
                ("system", """You are generating research questions for financial document analysis.
    ...
    async def _create_content_outline(self, state: ResearchState) -> ResearchState:
        ...
        try:
            ...
            outline_prompt = ChatPromptTemplate.from_messages([
                ("system", """You are creating a detailed content outline for a financial document section.
            ...
            for i, section in enumerate(main_sections):
                try:
                    ...
                    content_prompt = ChatPromptTemplate.from_messages([
                        ("system", """You are writing detailed content for a financial document section.
